        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#" className="text-gray-600 hover:text-[#F3C300] transition">Location</a>
              <a href="#" className="text-gray-600 hover:text-[#F3C300] transition">Prestations</a>
              <a href="#" className="text-gray-600 hover:text-[#F3C300] transition">Comment ça marche ?</a>
            </div>
          </div>
        </div>
      </nav>
